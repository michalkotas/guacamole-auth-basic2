...
package net.sourceforge.guacamole.net.basic2;
 ...
 * @author Michal Kotas
 */
public class Basic2FileAuthenticationProvider implements AuthenticationProvider<UsernamePassword> {

    private Logger logger = LoggerFactory.getLogger(Basic2FileAuthenticationProvider.class);
    ...
    public static final FileGuacamoleProperty BASIC_USER_MAPPING = new FileGuacamoleProperty() {
        ...
        @Override
        public String getName() { return "basic-user-mapping2"; }
